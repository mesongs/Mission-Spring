    ...
    <div class="main_menu">
      <nav id="nav_custom" class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
          ...
          <a class="navbar-brand logo_h" href="<%=request.getContextPath()%>"><img src="resources/img/logo.png" alt=""></a>
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-center" id="menuContent">
              ...
              <li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/receiptRegister.jsp">증빙관리</a>
              <li class="nav-item"><a class="nav-link" href="supprotCenter.jsp">지원센터</a>
              <li class="nav-select"><a calss="nav-link" href="<%=request.getContextPath()%>/login.jsp">로그인</a>
              <li class="nav-select"><a calss="nav-link" href="<%=request.getContextPath()%>/signUp.jsp">회원가입</a>
            </ul>
          </div> 
        </div>
      </nav>
