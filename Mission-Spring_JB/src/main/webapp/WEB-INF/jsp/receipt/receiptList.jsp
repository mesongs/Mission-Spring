	...
	<div class="comment-form-receipt" id="comment-custom-receipt" style="width: 1110px;">
		...
		<div class="container">
			<ul class="nav nav-tabs" style="margin-left: 50px;">
				...
				<li class="nav-item"><a class="nav-link" href="${ pageContext.request.contextPath }/receipt/homeTaxMain"><img class="product-img3" src="${ pageContext.request.contextPath }/resources/img/homeTax.png">홈택스 연동</a></li>
			</ul> 
