	...
	<div class="comment-form-receipt" id="comment-custom-receipt" style="width: 1110px;">
		...
		<div class="container">
			<ul class="nav nav-tabs" style="margin-left: 50px;">
				...
				<li class="nav-item"><a class="nav-link active" aria-current="page" href="#" style="padding-bottom: 10px";><i style="color:#27b2a5;" class="fas fa-check-circle"></i><sapn style="margin-left: 5px;">처리 완료 목록</sapn></a></li>
				...
				<li class="nav-item"><a class="nav-link" href="${ pageContext.request.contextPath }/receipt/allReceiptList"><i style="color:#27b2a5" class="fas fa-dot-circle"></i><span style="margin-left:5px;">통합 매입/매출 조회</span></a></li>
			</ul>
								...
								<div class="row">
									...
									<div class="col" align="right">
										<span style="float: right;">
											 <button id="excelBtn" style="height : 35px; border-top-left-radius: 5px;border-bottom-left-radius: 5px;border-top-right-radius: 5px;border-bottom-right-radius: 5px; font-size: 16px;"><i class="fas fa-file-excel"></i><span style="margin-left:5px;">Excel 다운로드</span></button>
										</span>	
									</div>
