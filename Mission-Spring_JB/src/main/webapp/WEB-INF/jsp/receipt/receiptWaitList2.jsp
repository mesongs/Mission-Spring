		...
		$.ajax({
			 ...
			 success : function(result){
				 ...
				 if(result.length >= 1){
					 ...
					 result.forEach(function(searchWaitList){
						 
						 	 alert(searchWaitList.regDate)
						 	 str="<tr>"
						     str +="<td>" + searchWaitList.regDate + "</td>"
						     str +="<td>" + searchWaitList.receiptName + "</td>"
				 ...
				 */
		 				...
		 				<%-- for(var i in result){
		 					...
		 					str='<tr>'
		 						...
		 						str += "<td>" + result[i].receiptName + "</td>"
		 						str +="<td>"+ result[i].purpose +"</td>";
		 						str +="<td>"+ result[i].memo +"</td>";
		 						str +="</tr>"
		 						$('#boardtable').append(str);
		 						
		 						/* str += "<td><a href="+ ${ pageContext.request.contextPath } +"/receipt/detail/" + result[i].receiptNo + ">" + result[i].receiptName +"</a></td>"; */
		 						str+="<td><a href = '/board/detail?idx=" + item.idx + "'>" + item.title + "</a></td>";
		 						str+="</tr>"
		 						$('#boardtable').append(str);
		 						
		 						<td><a href="${ pageContext.request.contextPath }/receipt/detail/{receiptNo}>"세금계산서</a></td>
									...
									<div class="col" style="width: 200px">
										<div>
											<form name="search-form" autocomplete="off">
												...
												<button id="searchBtn" type="submit" onclick="getSearchList()">검색</button>
												</span>
											</form>
										</div>
