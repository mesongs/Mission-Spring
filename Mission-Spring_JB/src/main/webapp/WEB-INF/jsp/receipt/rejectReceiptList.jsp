	...
	<div class="comment-form-receipt" id="comment-custom-receipt" style="width: 1110px;">
		...
		<div class="container">
			<ul class="nav nav-tabs" style="margin-left: 50px;">
				...
				<li class="nav-item"><a class="nav-link" href="${ pageContext.request.contextPath }/receipt/processedList"><i style="color:#27b2a5;" class="fas fa-check-circle"></i><sapn style="margin-left: 5px;">처리 완료 목록</a></li>
				...
				<li class="nav-item"><a class="nav-link active" aria-current="page" href="#" style="padding-bottom: 10px";><i style="color:#27b2a5" class="fas fa-times-circle"></i><span style="margin-left:5px;">반려 목록</span></a></li>
