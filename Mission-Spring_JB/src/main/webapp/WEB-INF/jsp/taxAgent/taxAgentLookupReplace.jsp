                    ...
                    <div class="condition" style="margin-top: 20px; border-top: 0px;">
						...
						<select name="selectOrder" id="selectOrder" style="margin-left: 15px; float: left; width: 55px; color:#495057; height: 35px;">
							 			...
							 			<span style="float: left">
												<button id="searchWriteForm" name="searchWriteForm" type="button" style="height : 35px; margin-left: 15px; border-top-left-radius: 5px;border-bottom-left-radius: 5px;border-top-right-radius: 5px;border-bottom-right-radius: 5px; font-size: 18px; font-weight: bold;">조회</button>
										</span>
